...
void main() {
  group('LoginScreen UI', () {
    ...
    testWidgets('login form has email, password fields and forgot password link', (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(home: LoginScreen()),
        ),
    ...
    testWidgets('register form has email, code, password fields', (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(home: LoginScreen()),
        ),
    ...
    testWidgets('shows validation error if fields empty on login', (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(home: LoginScreen()),
        ),
    ...
    testWidgets('shows validation error if fields empty on register', (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(home: LoginScreen()),
        ),
    ...
    testWidgets('shows validation error for send code without email', (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(home: LoginScreen()),
        ),
