...
**[功能优化]** 优化欢迎页，桌面端和移动端都保持主登录入口居中、界面更简洁。
**[问题修复]** 当服务端返回同一语义版本时不再误弹升级提示。

### v1.1.33 (2026-05-21)

**[新功能]** 新增 server-client 版本兼容性检查，并在更新流程中展示更清晰的版本信息。
**[问题修复]** 修复内部 macOS DMG 打包元数据问题，并优化 SkillHub 内置路径在触屏设备上的提示。
